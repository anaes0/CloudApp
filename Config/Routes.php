...
$routes->setDefaultController('Home');//changed from Home to Users
...
//$routes->get('/', 'mycontroller::fname');//name of controller plus function name
//$routes->add('second', 'mycontroller::fname1');
//$routes->add('add', 'mycontroller::fname2');
//$routes->add('view', 'mycontroller::fname3');

/*//crud example lesson
$routes->add('add', 'crud::create');
$routes->post('/submit', 'crud::store');
$routes->add('/view', 'crud::view');
$routes->add('/update/(:num)', 'crud::update/$1');
...
//4 Newbook registration routing
...
$routes->get('/', 'Home::index'); //changed from Home to Users
